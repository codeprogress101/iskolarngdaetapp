...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Future<void> _loadDashboard() async {
    ...
    try {
      ...
      if (!mounted) return;
      setState(() => _errorMessage = 'Failed to load dashboard: ${e.message}');
    } catch (e) {
      if (!mounted) return;
      setState(
            ...
            : RefreshIndicator(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    Text(
                      'Track your scholarship status and required actions.',
                    ...
                    SectionCard(
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text('Current Application Status'),
