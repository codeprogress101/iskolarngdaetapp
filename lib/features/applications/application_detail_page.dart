...
class _ApplicationDetailPageState extends State<ApplicationDetailPage> {
  ...
  Widget _staggered({required Widget child, required int step}) {
    return RevealOnMount(delayMs: 45 * step, child: child);
  }

  @override
  Widget build(BuildContext context) {
    if (_isLoading) {
      return const Scaffold(body: SkeletonList(count: 5));
    }
              ...
              _staggered(
                ...
                child: SectionCard(
                  ...
                  child: _documentsError != null
                      ...
                      : (_documents.isEmpty
                            ? const Text(
                                'No uploaded requirement documents yet.',
                              )
                            : Column(
                                children: _documents
                                    .map(
